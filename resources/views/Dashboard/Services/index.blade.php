...
{{--                                    <td>{{ $service->created_at->diffForHumans() }}</td>--}}
                                    <td>
                                        ...
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                           data-toggle="modal" href="#edit{{$service->id}}">Edit</a>

                                        <form action="{{ route('Services.destroy' , $service ->id ) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <input  class="modal-effect btn btn-sm btn-danger"  data-effect="effect-scale"  data-toggle="modal" type="submit" value="Delete">
