                    ...
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>تاريخ الاصدار</span> <span>{{$recipts->date}}</span>
                                </p>
                                <p class="invoice-info-row "><span>اسم المريض</span>
                                    <span>{{$recipts->patients->name}}</span></p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td class="tx-12">{{ $recipts->description}}</td>
                                    <td class="tx-center">{{ number_format($recipts->amount,2)}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
