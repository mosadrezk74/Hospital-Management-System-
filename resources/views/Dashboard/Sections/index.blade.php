                                ...
                                <div class="table-responsive">
                                    <table class="table text-md-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">{{trans('Dashboard/sections_trans.name_section')}}</th>
                                            <th class="wd-15p border-bottom-0">{{trans('Dashboard/sections_trans.desc')}}</th>
                                        ...
                                        @foreach($sections as $section)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="NNN">
                                                        <a href="{{ route('Sections.edit', $section->id) }}" class="modal-effect btn btn-sm btn-info">Edit</a>
                                        ...
                                        @foreach($sections as $section)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td><a href="{{route('Sections.show',$section->id)}}">{{$section->name_en}}</a> </td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('Sections.store') }}" method="post" autocomplete="off">
                                ...
                                <div class="modal-body">
                                    <label for="exampleInputPassword1">{{trans('Dashboard/sections_trans.desc')}}</label>
