                                                    ...
                                                    @foreach($patient_rays as $patient_ray)
                                                        <tr>
                                                            ...
                                                            @if($patient_ray->doctor_id == auth()->user()->id)
                                                                ...
                                                                <td>
                                                                    <div class="NNN">
                                                                        <a href="{{ route('rays.edit', $patient_ray->id) }}" class="modal-effect btn btn-sm btn-info">Edit</a>
                                                                        <form action="{{ route('rays.destroy', $patient_ray->id) }}" method="post" class="d-inline">
                                                                            @csrf
                                                                            @method('DELETE')
                                                        ...
                                                        @include('Dashboard.Doctors.invoices.deleted')
                                                    @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
