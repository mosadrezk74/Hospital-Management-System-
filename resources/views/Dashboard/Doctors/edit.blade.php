            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('Doctors.update',[$doctor->id]) }}" method="post" autocomplete="off"
                        ...
                        {{ csrf_field() }}
                        @csrf
                        <div class="pd-30 pd-sm-40 bg-white-500">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control"  name="name" value="{{$doctor->name}}" type="text" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" name="name2"  value="{{$doctor->name_en}}" type="text"  >
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" name="phone" type="tel" value="{{$doctor->phone}}" maxlength="11">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" name="appointment" value="{{$doctor->appointment}}" type="text"   >
                                </div>
                            </div>
                                <div class="row row-xs align-items-center mg-b-20">
                                    <div class="col-md-1">
