					...
					<div class="left-content">
						<div>
						  ...
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحبا بعودتك {{ Auth::user() ->name}}</h2>
							@else
								<h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Hi, {{ Auth::user() ->name_en}}</h2>
							@endif
...
@section('content')
				...
				<div class="row row-sm">
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-16">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">عدد المرضي في العيادة </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ $tot_med  }}</h4>
